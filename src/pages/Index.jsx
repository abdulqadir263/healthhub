...
import { Heart, UtensilsCrossed, Apple, TrendingUp, FileText, MessageSquare, ArrowRight, CheckCircle } from "lucide-react";
      ...
      <footer className="bg-card border-t border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <span className="text-2xl font-bold text-foreground">HealthHub</span>
          </div>
          <p className="text-center text-muted-foreground">
            © 2024 HealthHub. Your partner in health and wellness.
          </p>
        </div>
      </footer>
    </div>
